...
const TypoShop = () => {
    return (
        <Container className='mt-10'>
            <Typography className='font-bold' style={{ color: Colors.NavyBlue, fontSize: 36 }}>Shop</Typography>
            <div className='flex gap-1 mt-2'>
                ...
                <Typography className='font-medium' style={{ fontSize: 16, color: Colors.Black }}>.</Typography>
                <Typography className='font-medium' style={{ fontSize: 16, color: Colors.Pink }}>Shop</Typography>
            </div>
        </Container>
    )
}

export default TypoShop;